...
public class records_for_part extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_records_for_part);
        ...
        addproblem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent add_problem_intent = new Intent(records_for_part.this, add_problem.class);
