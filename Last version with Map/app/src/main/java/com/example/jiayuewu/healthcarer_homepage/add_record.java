...
public class add_record extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Add Record");
        Button patient_location=findViewById(R.id.patient_location_button);
        patient_location.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent m = new Intent(add_record.this, MapsActivity .class);
                startActivity(m);
            }
        });
