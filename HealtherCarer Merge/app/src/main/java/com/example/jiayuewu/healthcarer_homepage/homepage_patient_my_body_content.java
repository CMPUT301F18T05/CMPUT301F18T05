...
public class homepage_patient_my_body_content extends Fragment {
    ...
    public View onCreateView( LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState ) {
        ...
        AddProblem = rootView.findViewById(R.id.but_Aproblem);
        ...
        AddProblem.setOnClickListener(new View.OnClickListener() {
                                          ...
                                          public void onClick( View v ) {
                                              Intent Aproblems = new Intent(homepage_patient_my_body_content.this.getActivity(), ProblemHistory .class);
                                              startActivity(Aproblems);
                                          }
                                      });
                ...
                sbutton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick( View v ) {
                        // placeholder
                        Snackbar.make(v, "Search Button Action", Snackbar.LENGTH_LONG).setAction("Action", null).show();
                    }
                });
