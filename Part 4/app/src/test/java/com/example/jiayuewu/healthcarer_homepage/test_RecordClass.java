...
public class test_RecordClass {
    ...
    public void test_setRecord() {
        ...
        testRecord.setProblemID(123);
        testRecord.setRecordID(234);
    ...
    public void test_commentLengthMaximum() {
        ...
        Calendar currentTime = Calendar.getInstance();
        Location location = new Location("dummyprovider");
        Record testRecord2 = new Record(213, 123, "Finger", currentTime,
                location, "oww");
    ...
    public void test_titleLengthMaximum() {
        ...
        Calendar currentTime = Calendar.getInstance();
        Location location = new Location("dummyprovider");
        Record testRecord2 = new Record(213, 234, "Finger", currentTime,
                location, "oww");
