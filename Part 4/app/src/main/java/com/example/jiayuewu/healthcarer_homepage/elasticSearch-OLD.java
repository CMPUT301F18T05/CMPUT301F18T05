...
//            verifySettings();
//
//            Log.w("GOT HERERER ONE", "" + problems);
//
//
//            for (Problem problem : problems) {
//                Index index = new Index.Builder(problem).index("testing").type("problem").build();
//
//                Log.w("SDDDD", "" + index);
//
//                try {
...
//                Index index = new Index.Builder(record).index("testing").type("Record").build();
//
//                try {
//                    // where is the client?
//                    DocumentResult result = client.execute(index);
...
//                    DocumentResult result = client.execute(index);
//                    if (result.isSucceeded()) {
//                        user.setUserID(Integer.parseInt(result.getId()));
//                    } else {
//                        Log.i("Error", "Elastic search was not able to add the tweet.");
//                    }
//                }
